...
| 网站      | 支持功能                             | 访问链接                              | 特色                                |
| --------- | ----------------------------------- | ------------------------------------- | ----------------------------------- |
| 易写AI    | GPT4.0、GPT o1、Grok 3、Claude、AI绘画               | [xsimplechat.com](https://xsimplechat.com)| 支持多种AI模型，功能多样化           |
| Lify VIP  | GPT4.0、GPT4.0 turbo、GPT o1、AI PPT、插件 | [chat.lanjing.pro](https://chat.lanjing.pro) | 增强版GPT，支持多种办公插件           |
